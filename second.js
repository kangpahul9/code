...
// console.log(str.trim() )//remove whitespace from starting and ending   
...
let marks = [55,66,45,99,98]
let addd= 0,avg_marks=0; 
for(mark of marks)
{
    addd+=mark;
 }
avg_marks=addd / marks.length;
console.log(`The average is ${avg_marks} marks`)
